...
@objc @IBDesignable open class CircleProgressView: UIView {
    ...
    @IBInspectable open var trackWidth: CGFloat = 10.0 {
        didSet { setNeedsDisplay() }
    }
    ...
    @IBInspectable open var trackBackgroundColor: UIColor = UIColor.clear {
        didSet { setNeedsDisplay() }
    }
    ...
    @IBInspectable open var trackBorderColor:UIColor = UIColor.white {
        didSet { setNeedsDisplay() }
    }

    @IBInspectable open var trackBorderWidth: CGFloat = 10.0 {
        didSet { setNeedsDisplay() }
    }
...
//    }
    ...
    override open func draw(_ rect: CGRect) {
        ...
        trackWidth = self.frame.size.width / 10
        trackBorderWidth = self.frame.size.width / 30
